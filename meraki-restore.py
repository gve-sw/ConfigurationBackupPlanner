...
dashboard = session.post(posturl, json={'accountStatus': 'ok', 'email': 'myadmmin@domain.com', 'hasApiKey': False, 'id': 'XXXXXXXXXXXXX', 'lastActive': 1547850975, 'name': 'adminstrator123', 'networks': [], 'orgAccess': 'full', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
